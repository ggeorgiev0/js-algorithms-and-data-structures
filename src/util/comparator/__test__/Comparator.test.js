...
describe('Comparator', () => {
  it('should compare properly with the default comparator method', () => {
    ...
    expect(comparator.lessThan(-1, 1)).toBe(true);
    ...
    expect(comparator.lessThanOrEqual(null, null)).toBe(true);
  ...
  it('should compare properly with a custom comparator method', () => {
